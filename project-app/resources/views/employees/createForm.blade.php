...
@section('content')
    <div class="container">
        <h3 class="my-3">Create Form Employee</h3>
        <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input
                                    ...
                                    is-invalid
                                @enderror"
                                    id="hire_date" type="date" name="hire_date">
                                @error('hire_date')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                @enderror"
                                    ...
                                    <option value="Inventory Specialist">Inventory Specialist
                                    </option>
                                    ...
                                    <option value="Quality Control Inspector">Quality
